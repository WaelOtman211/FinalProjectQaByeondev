...
class TestPetLogic(unittest.TestCase):
    ...
    def test_add_book_to_war_list(self):
        ...
        self.assertEqual(expected_message, self.api_book.add_book_to_war_list(headers, list_id, item_id, is_institutional_user)['message'])
    ...
    def test_add_note_to_specific_book(self):
        ...
        self.assertEqual(expected_message,
                         self.api_book.add_note_to_specific_book(headers, list_id, item_id, note, isInstitutionalUser)[
                             'message'])
